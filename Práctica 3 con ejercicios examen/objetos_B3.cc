...
_ejer1::_ejer1(float radio1, float radio2, float altura, int  num1, int num2){
  vector <_vertex3f> perfil;
  _vertex3f aux;
  int i;
  for (i=0;i<num1/2;i++){
    aux.x=radio1*cos(M_PI*i/(num1-1)-M_PI/2);
    aux.y=radio1*sin(M_PI*i/(num1-1)-M_PI/2);
    aux.z=0;
    perfil.push_back(aux);
  }
  aux.x=radio2; aux.y=(-altura/2.0)+0.19; aux.z=0.0;
  perfil.push_back(aux);
  aux.x=radio2; aux.y=(altura/2.0)+0.19; aux.z=0.0;
  perfil.push_back(aux);
  parametros(perfil,num2,0,1,1);
}
...
_ejer2::_ejer2(float radio1, float radio2, int  num1, int num2){
  vector <_vertex3f> perfil;
  _vertex3f aux;
  int i;
  for (i=0;i<num1/2;i++){
  ...
  for (i=0;i<num1/2;i++){
    aux.x=radio2*cos(M_PI*i/(num1-1)-M_PI/2)+radio1;
    aux.y=radio2*sin(M_PI*i/(num1-1)-M_PI/2)+radio2;
    aux.z=0;
    perfil.push_back(aux);
  }
  parametros(perfil,num2,0,1,1);
...
glTranslatef(0.5,0.5+0.25,0.5);
glRotatef(giro1, 0, 1, 0);
glScalef(0.5,0.5,0.5);
cubo.draw(modo, r, g, b, grosor);
glScalef(2,2,2);

glTranslatef(0.0,0.25+0.25,0.0);
glRotatef(giro2, 0, 1, 0);
