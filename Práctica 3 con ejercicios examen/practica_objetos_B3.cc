...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CILINDRO, CONO, ESFERA, EXTRUSION, EXCAVADORA, COMPAS, EJER1, EJER2, EJER3} _tipo_objeto;
...
_compas compas;
_ejer1 ejer1(0.6,0.4,0.5,16,16);
_ejer2 ejer2(0.6,0.4,16,16);
_ejer3 ejer3;
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
        ...
        case 'K':t_objeto=EJER1;break;
        case 'J':t_objeto=EJER2;break;
        case 'H':t_objeto=EJER3;break;
	}
glutPostRedisplay();
}
