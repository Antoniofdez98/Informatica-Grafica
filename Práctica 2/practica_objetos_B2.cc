...
// tipos
typedef enum { CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, EXTRUSION, ESFERA, CILINDRO, CONO } _tipo_objeto;
...
void draw_objects()
{
	...
	case PIRAMIDE: piramide.draw(modo, 1.0, 0.0, 0.0, 5); break;
		case CILINDRO: cilindro.draw(modo, 0.0, 0.5, 0.5, 5); break;
		case CONO: cono.draw(modo, 0.0, 0.5, 0.5, 5); break;
		case ESFERA: esfera.draw(modo, 0.0, 0.5, 0.5, 5); break;
